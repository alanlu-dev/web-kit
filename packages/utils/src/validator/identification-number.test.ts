import { isNationalIdentificationNumberValid, isNewResidentCertificateNumberValid, isOriginalResidentCertificateNumberValid, isResidentCertificateNumberValid } from './identification-number'
...
describe('isNationalIdentificationNumberValid', () => {
  it('should only accept strings with length 10', () => {
    ...
    expect(isNationalIdentificationNumberValid(123456789 as unknown as string)).toBe(false)
    expect(isNationalIdentificationNumberValid(undefined as unknown as string)).toBe(false)
...
describe('isOriginalResidentCertificateNumberValid', () => {
  it('should only accept strings with length 10', () => {
    ...
    expect(isOriginalResidentCertificateNumberValid(30196818 as unknown as string)).toBe(false)
    expect(isOriginalResidentCertificateNumberValid(undefined as unknown as string)).toBe(false)
...
describe('isNewResidentCertificateNumberValid', () => {
  it('should only accept strings with length 10', () => {
    ...
    expect(isNewResidentCertificateNumberValid(930196810 as unknown as string)).toBe(false)
    expect(isNewResidentCertificateNumberValid(undefined as unknown as string)).toBe(false)
...
describe('isResidentCertificateNumberValid', () => {
  it('should only accept strings with length 10', () => {
    ...
    expect(isResidentCertificateNumberValid(58238842 as unknown as string)).toBe(false)
    expect(isResidentCertificateNumberValid(undefined as unknown as string)).toBe(false)
