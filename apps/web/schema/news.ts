import { z } from 'zod'
import { NotionDateSchema, NotionStatusSchema, NotionTitleSchema } from '@alanlu-dev/notion-api-zod-schema'
...
export const NewsSchema = z.object({
  ...
  發布日期: NotionDateSchema.transform((o) => o.date?.start.replaceAll('-', '/')),
