...
<template>
  <div
    class="center-content flex {gap:2x;py:15x} {py:10x;gap:3x}@tablet {gap:5x}@desktop {size:6x;f:14;p:0;rounded;fg:font-title;font:regular}>button {size:7x;f:16}>button@tablet {size:8x}>button@desktop"
  >
