...
<template>
  <ClientOnly>
    <!-- Grids -->
    <div class="center fixed hidden middle inset:0 full .dev_{block} b:1|dotted|primary/.5 max-w:screen-max pointer-events:none px:6x px:10x@desktop z:devPanel">
