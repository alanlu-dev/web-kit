              ...
              <div class="b2-r flex:1 p:3x|6x">
                ...
                <div class="flex ai:flex-start gap:1x jc:flex-start mt:2x">
                  <div class="center-content flex fg:font-title gap:1x">
                    <Iconfiy class="f:5x_iconify-icon" icon="material-symbols-light:date-range-outline-rounded" />
                ...
                <div class="flex ai:flex-start gap:1x jc:flex-start mt:2x">
                  <div class="center-content flex fg:font-title gap:1x">
                    <Iconfiy class="f:5x_iconify-icon" icon="material-symbols-light:location-on-outline" />
                ...
                <div class="flex ai:flex-start gap:1x jc:flex-start mt:2x">
                  <div class="center-content flex fg:font-title gap:1x">
                    <Iconfiy class="f:5x_iconify-icon" icon="ph:user-thin" />
                ...
                <div class="flex ai:flex-start gap:1x jc:flex-start mt:2x">
                  <div class="center-content flex fg:font-title gap:1x">
                    <Iconfiy class="f:5x_iconify-icon" icon="material-symbols-light:cleaning-services-outline-rounded" />
